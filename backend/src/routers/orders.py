...
async def create_order(
    user: CurrentUserDep, order_service: OrderServiceDep, cart_service: CartServiceDep
):
...
async def cancel_order(
    order_id: int, user: CurrentUserDep, order_service: OrderServiceDep
):
...
async def change_order_status(
    order_id: int, new_status: OrderStatus, order_service: OrderServiceDep
):
    order = await order_service.get_order(order_id)
