...
class ProductCRUD(Creatable, Retrievable, Updatable, Deletable):
    ...
    async def get_all(
        ...
        *,
        ...
        return await self._get_all(
            ...
            order_by=order_by or self.__class__.key,
    ...
    async def search(
        ...
        *,
        ...
        tsvector = func.to_tsvector(
            "english", models.Product.title + " " + models.Product.description
        )
        ...
        stmt = stmt.where(
            and_(tsvector.op("@@")(ts_query), models.Product.is_active == True)
        )
        stmt = stmt.limit(pagination and pagination.limit).offset(
            pagination and pagination.offset
        )
    ...
    async def update_product_rating(
        self, product_id: int, new_rating: float
    ) -> models.Product | None:
